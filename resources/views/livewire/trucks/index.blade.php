<div x-data="{ sidebarOpen: false }"
    ...
    <x-page-menu>
        <div>
            <span class="text-2xl text-white font-sans font-semibold">Manajemen Truk</span>
        </div>

        <div class="flex justify-around gap-3.5">
            <x-button wire:click="addTruck" style="white" class="hover:bg-gray-100 transition-colors">
            ...
            <x-button wire:click="exportExcel" wire:loading.attr="disabled" style="green" class="hover:bg-green-600 transition-colors">
                <span wire:loading.remove>Cetak .xlsx</span>
